...
/* RS <==> A2 */
#define LCDRegister 					(*((volatile uint16_t*) 0x6C000000)) /* RS = 0 */
#define LCDMemory						(*((volatile uint16_t*) 0x6C000002)) /* RS = 1 */
...
#define LCD_READ_REGISTER(REG)			LCDRegister=REG;LCDMemory;
